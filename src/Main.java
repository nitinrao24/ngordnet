...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        hns.startUp();
        NGramMap ngMap = new NGramMap(WORD_HISTORY_SIZE14377_FILE, YEAR_HISTORY_FILE);
        WordNet wnet = new WordNet(SYNSETS_SIZE82191_FILE, HYPONYMS_SIZE82191_FILE);
        hns.register("hyponyms", new HyponymsHandler(ngMap, wnet));
